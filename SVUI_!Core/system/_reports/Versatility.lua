...
Report.OnUpdate = function(self, elapsed)
    ...
    local versatility = BreakUpLargeNumbers(GetCombatRatingBonus(CR_VERSATILITY_DAMAGE_DONE) + GetVersatilityBonus(CR_VERSATILITY_DAMAGE_DONE))
    self.text:SetText("Versatility: " ..  "|cff22CFFF" .. versatility .. "");
