...
do
	...
	local WidgetButton_OnClick = function(self)
		local obj = self.obj;
		if(obj and obj.pullout and obj.pullout.frame and InkedSV and InkedSV.API) then
			InkedSV.API:Set("Frame", obj.pullout.frame, "Default", true)
		end
	end
	...
	local function Constructor()
		...
		if(InkedSV and InkedSV.API) then
			InkedSV.API:Set("PageButton", button, true)
		end
