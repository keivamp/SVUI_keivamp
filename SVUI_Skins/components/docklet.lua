...
-- DOCK_EMBEDS["SVUI_QuestTracker"] = function(self)
	...
	-- SVUI_QuestTrackerScrollFrame:SetParent(self)
	 ...
	 -- _G['SVUI_QuestTrackerScrollFrameScrollChild']:SetHeight(1000)
	 -- _G['SVUI_QuestTrackerScrollFrame2']:SetHeight(1000)
...
DOCK_EMBEDS["Details"] = function(self)
	...
	-- if ("Details") then
		-- _G['SVUI_QuestTrackerScrollFrame']:Hide()
		-- else
		-- _G['SVUI_QuestTrackerScrollFrame']:Show()
	-- end
    ...
    for i=1, maxInstance do
		...
		_G['DetailsBaseFrame'..i]:SetFrameLevel(120)
