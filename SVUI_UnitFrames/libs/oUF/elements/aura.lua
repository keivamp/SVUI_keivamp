...
local CreateAuraBar = function(self, index)
	...
	local iconHolder = CreateFrame('Frame', nil, frame, BackdropTemplateMixin and "BackdropTemplate")
	...
	local barHolder = CreateFrame('Frame', nil, frame, BackdropTemplateMixin and "BackdropTemplate")
