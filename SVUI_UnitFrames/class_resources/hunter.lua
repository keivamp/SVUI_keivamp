...
function MOD:CreateClassBar(playerFrame)
	...
	--for i = 1, max do
		...
		--bar[i]:SetStatusBarTexture("Interface\\AddOns\\SVUI_UnitFrames\\assets\\Class\\HUNTER-TRAP.blp")
		...
		--bar[i].bg:SetTexture("Interface\\AddOns\\SVUI_UnitFrames\\assets\\Class\\HUNTER-TRAP-BG.blp");
